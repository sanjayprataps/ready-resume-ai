...
const featuresData = {
  ...
  features: [
    ...
    // Row 2
    {
      ...
      description: "Get a quick Portfolio generated by answering our guided questions.",
      icon: "User",
      cta: "Build Portfolio",
    ...
    {
      name: "Job Search",
      description: "Get personalized job matches by matching to keywords or your Resume data.",
      icon: "Search",
      cta: "Search Jobs",
      route: "/job-search",
      fullWidth: true
